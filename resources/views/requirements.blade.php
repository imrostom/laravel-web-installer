...
@section('template_title')
    {{ trans('LaravelWebInstaller::installer_messages.requirements.templateTitle') }}
@endsection

@section('title')
    <i class="fa fa-list-ul fa-fw" aria-hidden="true"></i>
    {{ trans('LaravelWebInstaller::installer_messages.requirements.title') }}
@endsection
...
@section('container')
    ...
    @if ( ! isset($requirements['errors']) && $phpSupportInfo['supported'] )
        <div class="buttons">
            <a class="button" href="{{ route('LaravelWebInstaller::permissions') }}">
                {{ trans('LaravelWebInstaller::installer_messages.requirements.next') }}
